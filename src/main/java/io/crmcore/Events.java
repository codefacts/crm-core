...
final public class Events {
    ...
    public static final String NEW_ADMIN_CREATED = "new-admin-created";
    public static final String NEW_HEAD_OFFICE_CREATED = "new-head-office-created";
    public static final java.lang.String FIND_ALL_TOWNS = "FIND_ALL_TOWNS";
    public static final java.lang.String FIND_ALL_DISTRIBUTION_HOUSES = "FIND_ALL_DISTRIBUTION_HOUSES";
    public static final java.lang.String FIND_ALL_BRANDS = "FIND_ALL_BRANDS";
    ...
    public static final java.lang.String GET_DB_TREE = "GET_DB_TREE";
